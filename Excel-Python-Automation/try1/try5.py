...
#excel_files = ['INPUT.xlsx','INPUT2.xlsx']
import glob
...
#for file in excel_files:
    ...
    #w=openpyxl.load_workbook('G:/rish project/OUTPUT1.xlsx')
    w=xlsxwriter.Workbook('G:/rish project/OUTPUT1.xlsx')
    #worksheet2= w["Sheet1"]
    worksheet2 = w.add_worksheet() 
    #worksheet2.extend(a)
    worksheet2.write(a)
    w.save('OUTPUT.xlsx')
