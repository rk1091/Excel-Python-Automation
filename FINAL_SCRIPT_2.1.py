...
try:
    ...
    for file in glob.glob('*.xlsx'):
        ...
        try:
            ...
            print('\nName of file with Type Error: ', file) 
            #print('\nPlease make sure that the input excel files have data according to the correct format (i.e apart from name, input only numbers elsewhere).')        
